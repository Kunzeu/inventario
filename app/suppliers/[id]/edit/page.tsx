...
export default function EditSupplierPage() {
  ...
  const loadSupplier = async () => {
    try {
      ...
      toast.error(error.message || t('suppliers.errorLoading'))
  ...
  return (
    <MainLayout>
      <div className="space-y-6">
        <h1 className="text-3xl font-bold text-gray-900">{t('common.edit')} {t('suppliers.title')}</h1>
              ...
              <div>
                <label className="flex items-center gap-2">
                  <input
                    ...
                    className="rounded"
                  />
                  <span className="text-sm font-medium">{t('suppliers.status')}</span>
                </label>
              </div>
